...
public class I18nUpdateMod {
    ...
    public static final Path CACHE_DIR = Paths.get(System.getProperty("user.home"), "." + MOD_ID, "");
    ...
    public static final Path LANGUAGE_PACK = CACHE_DIR.resolve("Minecraft-Mod-Language-Modpack.zip");
    public static final Path LANGUAGE_MD5 = CACHE_DIR.resolve("1.16.md5");
    public static final String LINK = "https://gitcode.net/chearlai/translationpackmirror/-/raw/main/files/Minecraft-Mod-Language-Modpack.zip";
    public static final String MD5 = "https://gitcode.net/chearlai/translationpackmirror/-/raw/main/files/1.12.2.md5";
